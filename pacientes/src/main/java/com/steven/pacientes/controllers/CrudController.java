...
import com.steven.pacientes.services.CommonCrud;
...
@AllArgsConstructor
@Validated
public class CrudController <RQ,RS,S extends CommonCrud<RQ,RS>>{
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RS> obtenerId(@PathVariable @Positive(message = "El id debe de ser positivo ")Long id)
